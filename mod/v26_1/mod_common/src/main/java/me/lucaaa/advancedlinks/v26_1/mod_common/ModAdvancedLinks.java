package me.lucaaa.advancedlinks.v26_1.mod_common;
...
import me.lucaaa.advancedlinks.v26_1.mod_common.data.ModLinkReceiver;
import me.lucaaa.advancedlinks.v26_1.mod_common.data.ModMessageReceiver;
import me.lucaaa.advancedlinks.v26_1.mod_common.managers.ModConfigManager;
import me.lucaaa.advancedlinks.v26_1.mod_common.managers.ModLinksManager;
import me.lucaaa.advancedlinks.v26_1.mod_common.tasks.ModTaskManager;
...
public abstract class ModAdvancedLinks implements AdvancedLinks<ServerLinks.UntrustedEntry, ServerLinks.KnownLinkType> {
    ...
    public ModMessageReceiver getMessageReceiver(CommandSourceStack sender) {
        return new ModMessageReceiver(this, sender);
    }
